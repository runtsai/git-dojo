...
describe("two independent long-running branches both merged into main", () => {
  ...
  //   |   \   |
  //  main1 bA2 bB1      ← main + both branches in flight simultaneously
  //   |     |  |
  //  bA1    |  |        ← branchA diverges from root
  //   \     /  |
  //    root    |        ← shared root
  //        \  /
  ...
  // During the window [main1, mergeA], branchA and branchB coexist with main.
