...
describe("two independent long-running branches both merged into main", () => {
  // History shape (newest first in array):
  //
  //   mergeB          ← merges main2 + bB3 into main  (row 0)
  //   |       \
  //   main2    bB3    ← main after mergeA; branchB tip (rows 1, 2)
  //   |        |
  //   mergeA   bB2    ← merges main1 + bA2 into main  (rows 3, 4)
  //   |    \   |
  //   main1 bA2 bB1   ← main tip before any merge; branchA tip; branchB (rows 5,6,7)
  //   |     |   |
  //   bA1   |   |     ← branchA start                  (row 8)
  //   |     |   |
  //   root (shared)                                     (row 9)
