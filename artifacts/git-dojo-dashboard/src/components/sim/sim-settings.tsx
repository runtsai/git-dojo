...
export function SimSettingsField({ 
  ...
  return (
    <div className="space-y-2 relative">
      ...
      {children}
      {helpText && <p className="text-white/50 text-xs">{helpText}</p>}
    </div>
  );
}
  ...
  return (
    <div className="space-y-3">
      ...
      >
        ...
        <div>
          <div className="flex items-center gap-2 font-bold text-white text-sm">
            <Globe className="w-4 h-4 text-white/50" /> Public
          </div>
          <p className="text-white/50 text-xs mt-1">Anyone on the internet can see this repository. You choose who can commit.</p>
        </div>
      </label>
      ...
      >
        ...
        <div>
          <div className="flex items-center gap-2 font-bold text-white text-sm">
            <Lock className="w-4 h-4 text-white/50" /> Private
          </div>
          <p className="text-white/50 text-xs mt-1">You choose who can see and commit to this repository.</p>
        </div>
      </label>
    </div>
  );
