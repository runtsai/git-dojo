...
export const MODULE_1_5_STEP_HINTS: Record<number, ReactNode> = {
  1: (
    <span>
...
export function Module1_5({ onStepChange }: VisualModuleProps = {}) {
  ...
  return (
    <VisualModuleShell
      ...
      error={showError}
      stepHints={MODULE_1_5_STEP_HINTS}
      moduleId="1.5"
    >
      {step === 1 && (
        <>
...
// Suppress unused import warning – Map is intentionally kept for future use
void Map;
